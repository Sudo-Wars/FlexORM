package nz.co.codec.flexorm.command
{
    ...
    {
        public function ConstraintUpdateTriggerCommand(sqlConnection:SQLConnection, schema:String, table:String, column:String, constraintTable:String, constraintColumn:String, debugLevel:int = 0)
        {
